...
{
    /// <summary>
    /// Comparison of the total counts of the two stats.
    /// </summary>
    public class CountComparedStat : IComparedStat
    {
        ...
        public string Name => "Count Compared";
        /// <summary>The string value of the stat.</summary>
        public string StringValue { get; set; }

        internal CountComparedStat(string memberName, CountStat stat1, CountStat stat2)
        {
